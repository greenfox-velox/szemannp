...
class ToDo():
    ...
    def touch_new_list(self):
        with open('todo_list.csv', 'a') as todo_list_file:
    ...
    def add_new_task(self):
        with open('todo_list.csv', 'a', newline = '') as todo_list_file:
    ...
    def remove_task(self):
        ...
        with open("todo_list.csv","r") as file_todo:
            todo_list = list(file_todo)
            del todo_list[delete_line - 1]
        with open("todo_list.csv","w") as file_todo:
            for n in todo_list:
                file_todo.write(n)
    ...
    def print_todo_list(self):
        with open('todo_list.csv', 'r') as todo_list_file:
    ...
    def mark_task_checked(self):
        ...
        todo_list_file.close()
        with open('todo_list.csv', 'w') as todo_list_file:
